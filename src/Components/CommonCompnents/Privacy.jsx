  ...
  return (
    <React.Fragment>
      ...
      <div className={classes.para}>
        <p>
          Oaknst (“us”, “we”, or “our”) operates the https://www.oaknst.com
          website (the “Service”). Reference to Oaknst includes its current &
          future associate or subsidiary companies throughout this policy.
        </p>
        <p>
          ...
          accessible from https://www.oaknst.com{" "}
        </p>
        ...
        <p>
          ...
          <h3>Use of Data Oaknst </h3>
          <p>uses the collected data for various purposes: </p>
          <ul>
            <li>To provide and maintain the Service </li>
            <li>To notify you about changes to our Service</li>
            <li>To notify you about our services, additions, promotions etc</li>
            <li>
          ...
          agreement to that transfer. Oaknst will take all steps reasonably
          ...
          other personal information <h3>Disclosure Of Data</h3> Legal
          Requirements{" "}
          <p>
            Oaknst may disclose your Personal Data in the good faith belief that
            such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Oaknst </li>
            <li>
          ...
          <h3>Security Of Data</h3> The security of your data is important to us
          ...
          <p>
            ...
            us by sending email to info@oaknst.com
          </p>
        </p>
      </div>
      <Footer />
